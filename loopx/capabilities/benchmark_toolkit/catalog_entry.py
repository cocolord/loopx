...
BENCHMARK_TOOLKIT_CATALOG_ENTRY: dict[str, Any] = {
    ...
    "commands": [
        ...
        },
        {
            "command": (
                ...
                "[--evidence-binding-json <binding.json> "
                "--expected-launch-sha256 <pinned-digest> "
                "--external-agent-result-json <result.json> "
                "--route-receipt-json <route.json>] "
                "--require-qualified --format json"
            ),
            "purpose": (
    ...
    "implemented_protocols": [
        ...
        {
            "schema_version": "benchmark_evidence_binding_v0",
            "module": "loopx.capabilities.benchmark_toolkit.evidence_binding",
            "doc": "loopx/capabilities/benchmark_toolkit/README.md",
        },
        {
