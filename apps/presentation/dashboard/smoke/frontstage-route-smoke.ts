...
includes(frontstageSource, 'data-testid="frontstage-operator-state-legibility"', "operator state legibility panel");
includes(frontstageSource, "Operator State Legibility", "operator state legibility title");
includes(frontstageSource, "deriveOperatorStateSignals", "operator state signal helper");
includes(frontstageSource, "actionKindTone", "action kind tone helper");
includes(frontstageSource, "leaseStatusTone", "lease status tone helper");
includes(frontstageSource, "eventClassificationTone", "event classification tone helper");
includes(frontstageSource, "until {lease.lease_until}", "lease expiry render");
includes(frontstageSource, "lease.write_scope.map", "lease write-scope render");
